 ...
 *            VBRI header support added, E.B javalayer@javazoom_modified.net
 * 
 * 12/04/03 : VBR (XING) header support added, E.B javalayer@javazoom_modified.net
 *
 * 02/13/99 : Java Conversion by javazoom_modified , E.B javalayer@javazoom_modified.net
 *
 ...
 *----------------------------------------------------------------------
 */
package javazoom_modified.jl.decoder;
...
public final class Header
{
	 ...
	 * @param firstframe
	 * @author E.B (javalayer@javazoom_modified.net)
	 */
