...
package javazoom_modified.jl.player.advanced;

import java.io.InputStream;

import javazoom_modified.jl.decoder.Bitstream;
import javazoom_modified.jl.decoder.BitstreamException;
import javazoom_modified.jl.decoder.Decoder;
import javazoom_modified.jl.decoder.Header;
import javazoom_modified.jl.decoder.JavaLayerException;
import javazoom_modified.jl.decoder.SampleBuffer;
import javazoom_modified.jl.player.AudioDevice;
import javazoom_modified.jl.player.FactoryRegistry;

/**
 * a hybrid of javazoom_modified.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
