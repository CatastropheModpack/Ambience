 ...
 * 
 * 06/04/01		Streaming support added. javalayer@javazoom_modified.net
 * 
...
package javazoom_modified.jl.player;
...
public class jlp
{
	...
	public void showUsage()
	{
		...
		System.out.println("");
		System.out.println(" e.g. : java javazoom_modified.jl.player.jlp localfile.mp3");
		System.out.println("        java javazoom_modified.jl.player.jlp -url http://www.server.com/remotefile.mp3");
		System.out.println("        java javazoom_modified.jl.player.jlp -url http://www.shoutcastserver.com:8000");
	}
